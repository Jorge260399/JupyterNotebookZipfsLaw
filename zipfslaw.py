...
def generate_zipf_table(text, top):
    ...
    palabras más frecuentes, sus frecuencias y otros 
    datos zipfianos.
    """
...
def _top_word_frequencies(text, top):
    ...
    """
    Crear una lista de tuplas que contenga 
    las palabras más frecuentes y sus frecuencias
    ...
    # Crear una instancia de collections.Counter a partir de un
